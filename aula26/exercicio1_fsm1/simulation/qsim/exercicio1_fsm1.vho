...
ARCHITECTURE structure OF exercicio1_fsm1 IS
...
SIGNAL \s[1]~feeder_combout\ : std_logic;
...
SIGNAL ALT_INV_s : std_logic_vector(2 DOWNTO 0);
...
\s[1]~feeder\ : cyclonev_lcell_comb
-- Equation(s):
