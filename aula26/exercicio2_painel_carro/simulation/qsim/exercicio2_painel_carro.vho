...
ARCHITECTURE structure OF exercicio2_painel_carro IS
...
SIGNAL ww_km_parcial : std_logic;
SIGNAL ww_km_restante : std_logic;
SIGNAL ww_consumo : std_logic;
SIGNAL ww_km_total : std_logic;
...
SIGNAL \km_parcial~reg0_q\ : std_logic;
SIGNAL \Mux0~1_combout\ : std_logic;
SIGNAL \km_restante~reg0_q\ : std_logic;
SIGNAL \Mux0~2_combout\ : std_logic;
SIGNAL \consumo~reg0_q\ : std_logic;
SIGNAL \Mux2~0_combout\ : std_logic;
SIGNAL \km_total~reg0_q\ : std_logic;
SIGNAL s : std_logic_vector(1 DOWNTO 0);
SIGNAL \ALT_INV_bt~input_o\ : std_logic;
SIGNAL \ALT_INV_prev_bt~q\ : std_logic;
SIGNAL ALT_INV_s : std_logic_vector(1 DOWNTO 0);
SIGNAL \ALT_INV_km_total~reg0_q\ : std_logic;

BEGIN

ww_clk <= clk;
ww_bt <= bt;
km_parcial <= ww_km_parcial;
km_restante <= ww_km_restante;
consumo <= ww_consumo;
km_total <= ww_km_total;
ww_devoe <= devoe;
ww_devclrn <= devclrn;
ww_devpor <= devpor;
...
ALT_INV_s(1) <= NOT s(1);
ALT_INV_s(0) <= NOT s(0);
\ALT_INV_km_total~reg0_q\ <= NOT \km_total~reg0_q\;

-- Location: IOOBUF_X89_Y37_N56
\km_parcial~output\ : cyclonev_io_obuf
...
\km_restante~output\ : cyclonev_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false",
...
\consumo~output\ : cyclonev_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false",
...
\km_total~output\ : cyclonev_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false",
